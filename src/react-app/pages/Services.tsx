      ...
      <section className="page-hero" data-testid="services-hero">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl text-center">
          ...
          <p className="text-brand-muted text-lg max-w-2xl mx-auto">
            We offer a wide range of evidence-based psychological services to
          ...
          <div className="space-y-12">
            {SERVICES.map((service, i) => {
              ...
              return (
                <div
                  key={service.id}
                  className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-start p-8 rounded-3xl ${
                    isEven ? "bg-brand-beige" : "bg-white border border-border"
                  }`}
                  ...
                  <div className={isEven ? "" : "lg:order-2"}>
                    <div
                      className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-4 ${
                        service.color === "blue" ? "bg-blue-50" : "bg-green-50"
                      }`}
                    >
                      <Icon
                        size={26}
                    ...
                    <h2 className="font-heading text-2xl md:text-3xl font-bold text-brand-text mb-3">
                      {service.title}
                    </h2>
      ...
      <section className="py-16 bg-brand-beige" data-testid="services-cta">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl text-center">
          ...
          <p className="text-brand-muted text-lg mb-8 max-w-xl mx-auto">
            Book a consultation and our team will help guide you to the most
