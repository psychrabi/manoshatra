...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    designation: "Counseling Psychologist",
    license: "",
    bio: "Pammi takes special interest in family and couples therapy. She supports indviduals, couples and families in improving communication, navigating conflicts and building healthier relationships, while also helping individual manage a range of emotional and mental health concerns sunch as stress, anxiety, depression and life transitions.",
    initials: "PT",
    color: "bg-teal-500",
  },
  {
